...
namespace CustomMath
{
    public class Quaternions : MonoBehaviour
    {
        ...
        /*public Quaternion(Quaternions q)
        {
            this.x = q.x;
            this.y = q.y;
            this.z = q.z;
        ...
        public static Quaternions identity { get { return new Quaternions(0, 0, 0, 0); } }
        public Vec3 eulerAngles { get; set; }
        public Quaternions normalized { get; }
        ...
        {
            float dot;
            dot = Mathf.Sqrt(a.x + a.y + a.z + a.w) + Mathf.Sqrt(b.x + b.y + b.z + b.w) * Mathf.Cos(Quaternions.Angle(a, b));
            return dot;
        }
        ...
        public static Quaternions Lerp(Quaternion a, Quaternion b, float t)
        {
            throw new NotImplementedException();
        }
